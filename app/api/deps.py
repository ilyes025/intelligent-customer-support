...
async def get_current_staff_user(current_user: AuthUserDep) -> User:
    """Require the authenticated user to have staff privileges."""
...
StaffUserDep = Annotated[User, Depends(get_current_staff_user)]
